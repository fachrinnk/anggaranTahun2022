...
$datas = $db->getTable("SELECT kode_kegiatan, nama_kegiatan, CONCAT('Rp', FORMAT(anggaran_kegiatan, 2)) as anggaran_kegiatan, CONCAT('Rp', FORMAT(terpakai_kegiatan, 2)) as terpakai_kegiatan FROM kegiatan");
?>
<!DOCTYPE html>
<html lang="en">
