...
$datasBulan = $db->getTable("SELECT * FROM v_daya_serap_bulan");
$datasIk = $db->getTable("SELECT * FROM v_daya_serap_ik");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="content-wrapper">
        <div class="row">
          <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title">Daya Serap</h4>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><label
                            class="badge <?= ($data['keterangan'] == 'IKU') ? 'badge-success' : 'badge-warning'; ?>"><?= $data['keterangan'] ?></label>
                        </td>
                      </tr>
                      <?php
