...
$datas = $db->getTable("SELECT * FROM v_coa");
?>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-description">
            <code>Sertifikat Badan Usaha</code>
          </p>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php
                    if ($data['kode_sbu_3'] == NULL) {
                      $span = 2;
                    } else if ($data['kode_sbu_4'] == NULL) {
                      $span = 3;
                    } else if ($data['kode_sbu_5'] == NULL) {
                      $span = 4;
                    } else {
                      $span = 5;
                    }
