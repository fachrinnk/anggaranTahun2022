...
$datas = $db->getTable("SELECT kode_ik, nama_ik, CONCAT('Rp', FORMAT(anggaran_ik, 2)) as anggaran_ik, CONCAT('Rp', FORMAT(terpakai_ik, 2)) as terpakai_ik, ket_ik FROM iku_ikt WHERE ket_ik = 'IKT'");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="container-fluid page-body-wrapper">
    ...
    <div class="col-lg-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">IKT</h4>
          <p class="card-description">
            <code>Indikator Kinerja Tambahan</code>
          </p>
