...
$datas = $db->getTable("SELECT * FROM v_ik_kegiatan");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="navbar-menu-wrapper d-flex align-items-top">
            <ul class="navbar-nav">
                <li class="nav-item font-weight-semibold d-block ms-0 mt-3">
                    <h1 class="welcome-text text-success">Selamat Datang, <span class="text-black fw-bold"><?= $name[0]['username'] ?></span></h1>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Kegiatan IK</h4>
                      ...
                      User
                            ...
                            <tbody>
                                ...
                                ?>
                                    <td>
                                        <?php
                                        if ($beforeKode != $data['kode_ik']) {
                                            echo $data['kode_ik'];
                                            $beforeKode = $data['kode_ik'];
                                        }
                                        ?>
                                    </td>
                                    <td>
                                        <?php
                                        if ($beforeKeg != $data['nama_ik']) {
                                            echo $data['nama_ik'];
                                            $beforeKeg = $data['nama_ik'];
                                        }
                                        ?>
                                    </td>
                                    <td>
