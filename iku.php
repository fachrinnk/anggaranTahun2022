...
$datas = $db->getTable("SELECT kode_ik, nama_ik, CONCAT('Rp', FORMAT(anggaran_ik, 2)) as anggaran_ik, CONCAT('Rp', FORMAT(terpakai_ik, 2)) as terpakai_ik, ket_ik FROM iku_ikt WHERE ket_ik = 'IKU'");
      ...
      <div class="card">
        <div class="card-body">
          ...
          <p class="card-description">
            <code>Indikator Kinerja Utama</code>
          </p>
